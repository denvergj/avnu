    ...
    return (
      <div className="our-agents-page">
                  ...
                  if (i < 3) {
                    return (
                      <div key={i} className="content">
                        <img
                          src={
                            agent.fields.agentTile
                              ? agent.fields.agentTile.fields.tileImage.fields
                                  .file.url
                              : ""
                          }
                        />
                        <div className="info">
                          ...
                          <Link
                            to={`/our-agents/${agent.fields.slug}/`}
        ...
        >
          <div>
            {this.state.quotes &&
              this.state.quotes.map((quotes, i) => {
                if (i == 0) {
                  return (
          ...
          <div>
            {this.state.quotes &&
              this.state.quotes.map((quotes, i) => {
                if (i == 1) {
                  return (
                    <div key={i} className="the-quote quote-secondary">
                      <img src="/images/man-white.png" />
                      <p>{quotes.fields.quoteBody}</p>
                    </div>
                  );
