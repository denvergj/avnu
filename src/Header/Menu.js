    ...
    return (
      <div className="menuArea">
        <button
          type="button"
          className={
            (this.state.isOpen ? "is-active" : "hidden") +
        ...
        >
          ...
          <a href="/">
            <img
              src="https://images.ctfassets.net/dkcrc82u6zt9/5dmP7ER9zO8wMUs4UkYYwg/e28d44c0ef1cbeed182835a56362719a/avnu-logo.png"
              className="App-logo"
              alt="logo"
            />
          </a>
        </button>
        <OverlayMenu open={this.state.isOpen} onClose={this.toggleMenu}>
          ...
          <div
            className={
              "menu-item " + (this.state.subMenuOpen == 1 ? "open" : "")
            }
            onClick={this.toggleSubMenu.bind(this, 1)}
          >
            About Avnu{" "}
            <i
              className={
                "fas " +
                (this.state.subMenuOpen == 1
                  ? "fa-chevron-up"
                  : "fa-chevron-down")
              }
            />
            <div className="sub-menu">
              {this.state.contentPages &&
                this.state.contentPages.map((contentPage, i) => {
                  return (
                    <div key={i} className="menu-item">
                      <Link
